...
<script type="text/javascript" src="${path }/res/js/shop/passport/login.js"></script>
	...
	<div class="r">
		...
		<form id="jvForm" action="${path }/user/login.do" method="post">
			...
			<li><label for="captcha">验证码：</label>
				...
				<img id="capthcaImage" src="${path }/user/getImage.do" onclick="changeImage()" class="code" alt="换一张" /><a href="javascript:void(0);" onclick="changeImage()" title="换一张">换一张</a></li>
