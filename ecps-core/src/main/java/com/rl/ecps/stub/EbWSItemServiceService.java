 ...
 * 2015-07-28T15:23:12.970+08:00
 * Generated source version: 2.4.2
 * 
 */
@WebServiceClient(name = "EbWSItemServiceService", 
                  wsdlLocation = "http://localhost:8086/ecps-portal/services/publishItem?wsdl",
...
public class EbWSItemServiceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8086/ecps-portal/services/publishItem?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EbWSItemServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8086/ecps-portal/services/publishItem?wsdl");
        }
        WSDL_LOCATION = url;
    }
