...
<div class="frameR"><div class="content">
    ...
    <h2 class="h2_ch">
      <span id="tabs" class="l">
        <a id="label1" href="${path}/order/listPayOrder.do?assignee=noPaidOrderer"   title="全部" class="nor">全部</a>
        <a id="label2" href="${path}/order/listPayOrder.do?assignee=noPaidOrderer&isCall=0"   title="未付款待外呼" class="nor">未付款待外呼</a>  
        <a id="label3" href="${path}/order/listPayOrder.do?assignee=noPaidOrderer&isCall=1"   title="已外呼" class="nor">已外呼</a>
      </span>
   ...
   <table cellspacing="0" summary="" class="tab" id="myTable">
    ...
    <td><a href="${path }/order/viewDetail.do?orderId=${tb.order.orderId}&taskId=${tb.task.id}&dirName=orderPay">查看</a></td>
    </tr>
    </c:forEach>
