...
<div class="frameR"><div class="content">
    ...
    <h2 class="h2_ch"><span id="tabs" class="l">
        ...
        <a id="label1" href="${path}/item/listAuditItem.do?showStatus=1&auditStatus=0" title="待审核实体商品" class="nor">待审核</a>
        <a id="label2" href="${path}/item/listAuditItem.do?showStatus=1&auditStatus=2"  title="审核不通过实体商品" class="nor">审核不通过</a>
        <a id="label3" href="${path}/item/listAuditItem.do?showStatus=1&auditStatus=1"   title="已审核实体商品" class="nor">已审核</a>
    </span></h2>

<form id="form1" name="form1" action="${path}/item/listItem.do" method="post">
    <input type="hidden" id="auditStatus" value="${qc.auditStatus }" name="auditStatus">
    <div class="sch">
        <p>搜索：
